...
$(function(){
    render();
    var content = "客官，来啦，坐吧！<br/>回复[帮助]可以查看所有可用的指令。";
    // 添加公众号的开场白
...
function send() {
    ...
    $.ajax({
        // url : $("#basePath").val() + "message/autoReply.do",
        url : $("#basePath").val() + "command/autoReply.do",
        type : "POST",
        dataType : "text",
        timeout : 10000,
        success : function (data) {
            appendDialog("talk_recordboxme","My账号",command);
 ...
 * @param command 发送的内容
 */
function appendDialog(myClass,name,command) {
    var div = "";
    div += "<div class='" + myClass + "'>";
    div += "<div class='user'><img src='" + $("#basePath").val() + "images/thumbs/" + myClass + ".jpg'/>" + name + "</div>";
